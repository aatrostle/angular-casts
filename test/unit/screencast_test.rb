...
class ScreencastTest < ActiveSupport::TestCase
  setup do
    @screencast_defaults = {
      ...
      summary: 'This will show you have to create a new facebook ' +
               'application and configure it. Then add some authentication ' +
               'with the omniauth-facebook gem and top it off with a ' +
               'client-side authentication using the Javascript SDK.',
      duration: '12:09',
      link: 'http://railscasts.com/episodes/360-facebook-authentication',
      published_at: Date.parse('Mon, 25 Jun 2012 00:00: -0700'),
      source: 'railscasts',
